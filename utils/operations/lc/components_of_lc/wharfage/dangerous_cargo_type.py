...
from landed_cost.components_of_landed_cost.wharfage_due.pom_micp.compute_containerized_dangerous_cargo import \
    WDComputeContainerizedDangerousCargo20Footer, WDComputeContainerizedDangerousCargo40Footer
        ...
        while True:
            ...
            if user_input in valid_user_input:
                ...
                if user_input == self.terminate_program:
                    ...
                    WDComputeContainerizedDangerousCargo20Footer(
                    ...
                    WDComputeContainerizedDangerousCargo40Footer(
                        total_number_of_containers
